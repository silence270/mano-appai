...
export default {
  ...
  // Safari duomenų apsauga
  install_title: 'Įsidėk Leaf į pagrindinį ekraną',
  install_why: 'Tai ne dėl patogumo. Safari ištrina svetainių duomenis, jei jos neatidaromos 7 dienas — įskaitant tavo. Į pagrindinį ekraną įsidėtiems app’ams tai negalioja.',
  install_how_ios: 'Apačioje spausk Dalintis ⬆︎, tada „Įtraukti į pagrindinį ekraną".',
  install_how_android: 'Atidaryk naršyklės meniu ir pasirink „Įdiegti programėlę".',
  install_continue: 'Vis tiek tęsti naršyklėje',
  install_risk: 'Duomenys gali dingti',
  install_done: 'Įsidėjau',
  storage_unsafe: 'Duomenys neapsaugoti nuo išvalymo',
  storage_safe: 'Naršyklė pažadėjo duomenų nesaugoti trumpai',
  storage_explain: 'Be to naršyklė gali viską išvalyti po savaitės, jei app’o neatidarysi.',
  backup_overdue: 'Nuo paskutinės kopijos praėjo {n} d.',
  backup_why_now: 'Duomenys yra tik šiame telefone. Kopija — vienintelis dalykas, kuris išliks pametus telefoną ar naršyklei viską išvalius.',
