...
export default {
  ...
  install_title: 'Add Leaf to your Home Screen',
  install_why: 'This is not about convenience. Safari deletes the data of websites that are not opened for 7 days — including yours. Apps added to the Home Screen are not affected.',
  install_how_ios: 'Tap Share ⬆︎ at the bottom, then “Add to Home Screen”.',
  install_how_android: 'Open the browser menu and choose “Install app” or “Add to Home screen”.',
  install_continue: 'Continue in the browser anyway',
  install_risk: 'Your data can disappear',
  install_done: 'I have added it',
  storage_unsafe: 'Data is not protected from being cleared',
  storage_safe: 'The browser promised to keep your data',
  storage_explain: 'Without this the browser may clear everything after a week of not opening the app.',
  backup_overdue: 'It has been {n} days since your last backup',
  backup_why_now: 'The data lives only on this phone. A copy is the only thing that survives a lost phone or a cleared browser.',
